...
## Breaking down the SCORM walls

The engineers behind tools like [Talvi](https://talvi.ai/){:target="_blank"}, [Filtered](https://filtered.com/){:target="_blank"} and [Thrive](https://www.thrivelearning.com/){:target="_blank"} have uncovered ways to unpack SCORM packages, even from within the LMS, and make them even more useful.
...
## Back to a focus on granular knowledge
...
<figure><img class="img-fluid" src="/post-images/2026/05/org-knowledge.png" alt="Organisational knowledge with branches for courses and performance support">
<figcaption><small>Focus on the organisational knowledge and the rest can be generated at the point of need</small></figcaption>
</figure>
...
Rather than giving people the finished product, we'd be giving them Lego&trade; blocks from which they (or their AI more likely) can create something bespoke for them, when they need it.
...
- **Identify** - What exists? What is needed? What needs updating?
- **Extract** - Work with Subject Matter Experts to distill and document
- **Organise** - Write clearly. Use metadata
- **Test** - Does the granular knowledge object make sense to the people who will use it? Is it compliant?
- **Promote** - Drive awareness so people will be aware of their need to improve their knowledge, develop skills and change behaviours
- **Maintain** - Ensure the knowledge objects remain current and valid
